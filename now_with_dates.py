...
def initialize_weekly_view():
    ...
    center_window(window, 1000, 900)

    # Header frame for the title and subtitle
    header_frame = tk.Frame(window, bg="#4C9EEB", pady=10)
    ...
    for i, day in enumerate(days_of_week):
        ...
        # Label for the day
        tk.Label(frame, text=day, font=("League Spartan", 15, "bold"), fg="white", bg=day_colors[day]).pack()
        tk.Label(frame, text=date_str, font=("League Spartan", 10), fg="white", bg=day_colors[day]).pack()
